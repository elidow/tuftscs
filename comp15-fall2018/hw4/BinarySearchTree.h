...
private:
        ...
        //these are helper functions that I created for ones
        //already declared. Description in .cpp
        int children_count(Node *node);
        void remove_with_one_child(Node *node, Node *p);
        void remove_with_two_children(Node *node, Node *o, Node *p);
